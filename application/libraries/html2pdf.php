...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__).'/html2pdf/exception.class.php');
    require_once(dirname(__FILE__).'/html2pdf/locale.class.php');
    require_once(dirname(__FILE__).'/html2pdf/myPdf.class.php');
    require_once(dirname(__FILE__).'/html2pdf/parsingHtml.class.php');
    require_once(dirname(__FILE__).'/html2pdf/parsingCss.class.php');
